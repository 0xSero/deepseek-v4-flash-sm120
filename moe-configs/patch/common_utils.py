...
from sglang.srt.utils.hf_transformers_utils import get_config as _sglang_get_config
...
def get_model_config(
    ...
    try:
        ...
        # Fall back to sglang's wrapper, which handles deepseek_v4/deepseek_ref
        # model_types that vanilla transformers does not recognize.
        config = _sglang_get_config(model_name, trust_remote_code=True)
